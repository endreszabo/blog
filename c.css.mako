...
.entry p.read-more a,.entry p a.more-link,.post-info-date,.post-info-category,.post-info-tags,#gotocomments,#addcomment{display:block;padding-left:20px;background:url("i.gif") no-repeat scroll 0 0;}
...
#rss a{background:url("i.gif") no-repeat 0 0;display:block;width:66px;height:20px;text-indent:-9999em;}
#twitter{position:absolute;top:-10px;right:95px;}
#twitter a{background:url("i.gif") no-repeat -70px 0;display:block;width:20px;height:20px;text-indent:-9999em;}
#facebook{position:absolute;top:-10px;right:191px;}
#facebook a{background:url("i.gif") no-repeat -95px 0;display:block;width:20px;height:20px;text-indent:-9999em;}
/* #sidebar */
...
#sidebar ul li{padding-left:15px;background:url("i.gif") no-repeat 0 -280px;}
#sidebar ul li:hover{background:url("i.gif") no-repeat -10px -260px;}
...
span#comments-addcomment{position:absolute;left:10px;top:2px;padding-left:20px;background:url("i.gif") no-repeat 0 -115px;}
